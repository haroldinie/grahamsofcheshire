    ...
    return (
       <div className="page-wrapper">
            ...
            <div className="shade">
                ...
                Welcome to Grahams of Cheshire - a bespoke event catering and private dining company located in the heart of Cheshire. As a family-run business, we bring over 20 years of culinary experience to the table, ensuring that every event we cater is a memorable one. Founded by Adrian, a seasoned expert in the catering industry, Grahams of Cheshire is committed to delivering exceptional food quality tailored to the unique needs of each client. Whether you're hosting an intimate private dinner or a large-scale event, our team provides personalized menus that blend creativity, fresh ingredients, and culinary excellence. At Grahams of Cheshire, we believe in making every occasion special, with a focus on meticulous service and extraordinary flavors. Let us help you create an unforgettable experience with food that delights the senses.  
                </p>    
