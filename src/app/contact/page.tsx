...
//                     <p className="text-sm text-gray-500 mt-4">Need to get in touch? All of our contact information is below or fill in the form and we'll get back to you.</p>
...
//                                     <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#DAA520'
...
//                                     </svg>
//                                 </div>
//                                 <a href="mailto:haroldinie123@gmail.com" className="text-[#AD974F] text-sm ml-4">
...
//                             <li className="flex items-center">
//                                 <div className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
//                                 <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='#DAA520' viewBox="0 0 482.6 482.6">
...
//                             </svg>
//                                 </div>
//                                 <a href="javascript:void(0)" className="text-[#AD974F] text-sm ml-4">
//                                     <small className="block">Phone</small>
//                                     <strong>07123456789</strong>
//                                 </a>
//                             </li>
//                         </ul>
//                     </div>
...
//                                     <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#AD974F'
//                                         viewBox="0 0 24 24">
//                                         <path
...
//     rows={6}
//     className="w-full text-gray-800 rounded-md px-4 py-2.5 border text-sm outline-blue-500"
// />
// <button type="submit"
