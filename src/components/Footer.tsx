...
export default function Footer() {
    return(
      ...
      <div className="flex flex-col md:flex-row items-start justify-between">
        ...
        <div className="flex flex-col items-center justify-center mt-4 w-full md:w-min">
          <div className="flex mt-4">
            <a href="https://www.facebook.com/profile.php?id=61562249138777" className="mr-4 hover:text-[#AD974F]">
              <svg
            ...
            <a href="https://www.instagram.com/grahams_of_cheshire/" className='hover:text-[#AD974F]'>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
